 ...
 * Mengukur kinerja sistem dalam kondisi penggunaan sehari-hari.
 *
 * Jalankan untuk hotelbooking (Go):
 *   k6 run k6/load_test.js
 *
 * Jalankan untuk RoomMasterb:
 *   k6 run -e TARGET=roommaster k6/load_test.js
 *
 * Simpan hasil ke file JSON:
 *   k6 run --out json=k6/results/load_hotelbooking.json k6/load_test.js
 */
...
// Pola: naik bertahap → tahan stabil → turun
export const options = {
  scenarios: {
    load: {
      ...
      stages: [
        ...
        { duration: '3m',  target: 20 },  // tahan 3 menit (steady state)
  ...
  thresholds: {
    ...
    booking_success_rate:    ['rate>0.90'],    // booking sukses > 90%
    booking_flow_duration_ms: ['p(95)<8000'], // flow lengkap < 8 detik
  },
};
...
export function handleSummary(data) {
  ...
  return {
    'k6/results/load_hotelbooking.json': JSON.stringify(data, null, 2),
  };
}
